...
### G3. Session budget, compact, cost, sage, cite style (P1) — done (remainder: LLM compact / session eval fixture; session FTS later)
...
### G17. Event-sourced session + prefix-stable packing (P0) — done (remainder: session FTS)

...
No deep dive yet for **#24 DeepSeek Harness** or **#25 Claude Code harness** — first-pass cards plus matrix rows are the record. Do not vendor Cordis / Claude Code.

## How to read

1. For **what to build next**, start at [../fusion/GAP_AUDIT.md](../fusion/GAP_AUDIT.md) (spine + fusion 1–5 done; post-polish next-5 is DeepSeek/Claude Code seams).

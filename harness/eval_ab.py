"""Fixture-suite Chroma vs TurboVec A/B runner.

Indexes each available persist dir, runs ``eval --compare-backends``, and
writes ``.docs/research/eval/RESULTS.md`` / ``RESULTS.json``. The TurboVec
